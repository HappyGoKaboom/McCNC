...
mods.foundry.Melting.addRecipe(<liquid:liquidglass> * 250, <terraqueous:item_main:108>, 1100); 
...
mods.foundry.AlloyMixer.addRecipe(<liquid:knightslime> * 72, [<liquid:if.pink_slime> * 50, <liquid:poison> * 125, <liquid:stone> * 144, <liquid:signalum> * 72]);
...
<foundry:machine:3>.displayName = "Liquid Infuser";
