...
// Warp Artifacts
<biomesoplenty:terrestrial_artifact>.addTooltip(format.yellow("Warp Artifact"));
<minecraft:ghast_tear>.addTooltip(format.yellow("Warp Artifact"));
<biomesoplenty:crystal_shard>.addTooltip(format.yellow("Warp Artifact"));
<advancedrocketry:crystal>.addTooltip(format.yellow("Warp Artifact"));
<defiledlands:calling_stone>.addTooltip(format.yellow("Warp Artifact"));
